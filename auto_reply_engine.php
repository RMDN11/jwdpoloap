...
class AutoReplyEngine
{
    ...
    public function processIncomingMessage($contactId, $message, $userName = 'Kak')
    {
        ...
        try {
            ...
            // ==============================================================
            // BLOKIR NOMOR PRIBADI (Agar tidak di-reply dan tidak masuk sistem)
            // ==============================================================
          $ignoredNumbers = [
                '6288223053149', 
                '62248232064090227' // Versi angka bersih dari ID di bawah
            ];
            
            // 2. Cek ID mentah bawaan dari sistem OneSender (termasuk simbol & huruf)
            $ignoredRawIds = [
                '62248232064090227@s.whatsapp.net'
            ];
            
            if (in_array($phone, $ignoredNumbers) || in_array($contactId, $ignoredRawIds)) {
                $this->logToFile("Auto-reply skipped & dropped: Contact is in ignore list ({$contactId})");
                // Menghentikan eksekusi secara total agar tidak masuk ke pesan.php
                return false; 
            }
            // ==============================================================
