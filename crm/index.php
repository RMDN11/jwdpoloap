...
$page = $_GET['page'] ?? 'home';
$allowedPages = ['home', 'chat', 'reminder', 'reminder-pembayaran', 'reminder-pengajar', 'more', 'activity', 'group'];
...
<head>
    ...
    <?php endif; ?>
    <?php if (in_array($page, ['reminder', 'reminder-pembayaran', 'reminder-pengajar'], true)): ?>
